...
class RueButton extends RueView
{
	...
	public static function Create(Parent:RueView, OnClick:Void->Void, Graphic:TileDesc = null, Position:PositionComponent = null, Width:Float = 1, Height:Float = 1):RueButton
	{
